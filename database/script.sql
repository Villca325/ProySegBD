...
('Carlos Cliente', 'cliente@test.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'cliente', NULL, TRUE),
...
-- Insertar gerentes (todos con contraseña 'password')
INSERT INTO usuarios (nombre_completo, email, password, rol, sucursal_id, activo) VALUES
...
-- insertar admin y auditor (todos con contraseña 'password')
INSERT INTO usuarios (nombre_completo, email, password, rol, sucursal_id, activo) VALUES
('Sofia Auditora', 'auditor@test.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'auditor', NULL, TRUE),
('Admin Global', 'admin@test.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', NULL, TRUE);

select * from usuarios;
select * from usuarios where rol like 'cliente'
