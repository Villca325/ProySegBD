...
import { Package, CheckCircle, Truck, Clock, XCircle, Eye, CreditCard } from 'lucide-react';
...
export default function VentasPage() {
    ...
    const [ventaPago, setVentaPago] = useState<{ id: number; total: number } | null>(null);
    ...
    const handlePagoExitoso = async () => {
        await fetchVentas();
        toast.success('Pago registrado. El estado de tu compra ha sido actualizado.');
    };
                                ...
                                <div className="p-6">
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <div className={`flex items-center space-x-1 px-3 py-1 rounded-full text-sm font-medium ${getEstadoColor(venta.estado)}`}>
                                    ...
                                    <div className="border-t border-gray-200 pt-4">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <div className="flex space-x-2">
                                                ...
                                                <button
                                                    onClick={() => handleVerDetalle(venta?.venta_id || venta.id)}
                            ...
                            <div className="space-y-4">
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <p className="font-medium">
                                        {format(new Date(selectedVenta.fecha), "dd 'de' MMMM 'de' yyyy, HH:mm", { locale: es })}
                                    </p>
                                </div>

                                <div className="bg-gray-50 p-4 rounded-lg">
                                    <p className="text-sm text-gray-500">Estado</p>
                                    <div className={`inline-flex items-center space-x-1 px-3 py-1 rounded-full text-sm font-medium ${getEstadoColor(selectedVenta.estado)}`}>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        {selectedVenta.detalles?.map((detalle) => (
                                            <div key={detalle.id} className="flex justify-between items-center border-b border-gray-200 py-2">
                                                <div>
                                ...
                                {selectedVenta.estado === 'pendiente' && user?.rol === 'cliente' && (
                                    <div className="pt-4">
                                        <button
                                            onClick={() => {
                                                setShowModal(false);
